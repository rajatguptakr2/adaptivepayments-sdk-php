...
class Configuration
{
	...
	public static function getAcctAndConfig()
	{
		$config = array(
				...
				"acct1.UserName" => "rajat-facilitator_api1.tekshapers.com",
				"acct1.Password" => "DDH9B2GMY44UE3RS",
				"acct1.Signature" => "AFcWxV21C7fd0v3bYYYRCpSSRl31AY21RGJf9-tlfAGHv5F1.Cjsvqhm",
